...
import { supportsColor, Chalk, type ChalkInstance } from "chalk";
...
export type Colors = ChalkInstance;
export type ColorFormatter = ChalkInstance;
 ...
 */
function getDefs(chalk: Colors): Record<InternalTokenType, ColorFormatter> {
  return {
    keyword: chalk.cyan,
 ...
 */
function highlightTokens(defs: Record<string, ColorFormatter>, text: string) {
  let highlighted = "";
